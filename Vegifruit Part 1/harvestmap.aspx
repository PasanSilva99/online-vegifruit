<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="harvestmap.aspx.cs" Inherits="Vegifruit_Part_1.harvestmap" %>
...
<body id="page-top">
    <form id="harvestmap" runat="server">
        <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="harvest-map.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-map">
                    ...
                    <li class="nav-item"><a class="nav-link" href="harvest-analyse.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-graph-up">
            ...
            <div class="container">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="text-primary m-0 font-weight-bold">Harvest - Map</h6>
                    </div>
                    <div class="card-body">
                        <div class="d-flex flex-grow-1 flex-shrink-0" style="height: 70vh;">
                            <div style="width: 30%;height: 70vh;">
                                <div class="card mb-4">
                                    <div class="text-justify d-xl-flex justify-content-xl-end align-items-xl-start"><img class="img-fluid" src="assets/img/icons8_menu_50px_1.png" style ="width:30vh;"/></div>
                                </div>
                            </div><iframe allowfullscreen="" frameborder="0" src="https://www.google.com/maps/embed/v1/view?key=AIzaSyA7M0TI9M3e5yWaKWDQj5imEejUFrJnKRA&amp;center=-33.8569%2C151.2152&amp;zoom=11" style="height: 70vh; width:100%; "></iframe>
                        </div>
                    </div>
                </div>
            </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="harvestMapKeells.aspx.cs" Inherits="Vegifruit_Part_1.harvestMapKeells" %>
...
<body id="page-top">
    <form id="harvestMapKeells" runat="server">
        <div id="wrapper">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-grow-1 flex-shrink-0" style="height: 70vh;">
                            <div style="width: 30%;height: 70vh;">
                                <div class="card mb-4">
                                    <div class="text-justify d-xl-flex justify-content-xl-end align-items-xl-start"><img class="img-fluid" src="assets/img/icons8_menu_50px_1.png" style="width:30%;"/></div>
                                </div>
                            </div><iframe allowfullscreen="" frameborder="0" src="https://www.google.com/maps/embed/v1/view?key=AIzaSyA7M0TI9M3e5yWaKWDQj5imEejUFrJnKRA&amp;center=-33.8569%2C151.2152&amp;zoom=11" style="width:100%; height: 70vh;"></iframe>
                        </div>
                    </div>
                </div>
            </div>

                ...
                <div class="container-fluid d-flex flex-column p-0">
                    <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                        <div class="sidebar-brand-icon rotate-n-15">
                            <img class="img-fluid" src="assets/img/Vegi%20Fruits%20Logo%20SVG%20NEW.svg" style="margin-top: 65px; margin-right: 0px; margin-left: -23px;" /></div>
                    </a>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                <div class="input-group">
                                    <asp:TextBox runat="server" ID="tb_search1" class="bg-light form-control border-0 small" type="text" placeholder="Search for ..."></asp:TextBox>
                                    <div class="input-group-append">
                                        <button class="btn btn-primary py-0" type="button" style="background: #8FC52A;"><i class="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li class="nav-item dropdown d-sm-none no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-search"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right p-3 animated--grow-in" aria-labelledby="searchDropdown">
                                        <div class="form-inline mr-auto navbar-search w-100">
                                            <div class="input-group">
                                                <asp:TextBox runat="server" ID="tb_search2" class="bg-light form-control border-0 small" type="text" placeholder="Search for ..."></asp:TextBox>
                                                <div class="input-group-append">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-row justify-content-center align-items-center align-content-center">
                                            <img style="width: 15%; margin: 2px;" src="assets/img/star.svg" /><img style="width: 15%; margin: 2px;" src="assets/img/star.svg" /><img style="width: 15%; margin: 2px;" src="assets/img/star.svg" /><img style="width: 15%; margin: 2px;" src="assets/img/HalfStar.svg" /><img style="width: 15%; margin: 2px;" src="assets/img/NoStar.svg" /></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                        ...
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    ...
                                                    <div class="form-group">
                                                        <asp:Button runat="server" class="btn btn-primary btn-sm" type="submit" Text="Save Settings" onClick="saveSettings_Click"/></div>
                                                </div>
                                            </div>
                                        </div>

        ...
        <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" style="margin-top: 70px;"><a class="nav-link active" href="home.html"><i class="fa fa-home"></i><span>Home</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="harvest-analyse.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-graph-up">
                     ...
                     <li class="nav-item"><a class="nav-link" href="harvest-analyse.html"><img class="log-in-icon" src="assets/img/keylogin.png" alt="navigation-login" /><span>&nbsp; Log In</span></a></li>
                </ul>
